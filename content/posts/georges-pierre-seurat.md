...
textSections:
  - textTitle: Seurat’s early years
    text: >-
      ...
      Overall, the young student’s early artistic education was fairly traditional. He enrolled in a local art school around 1875 before moving to the École des Beaux-Arts, which was at this time run by [Henri Lehmann](https://en.wikipedia.org/wiki/Henri_Lehmann). Lehmann was a student of [Jean-Auguste-Dominique Ingres](https://ia-prototype.larsbehrenberg.com/jean-auguste-dominique-ingres-biography.html) and as such, the teaching was firmly Neo-Classical, placing weight on drawing and composition.
  ...
  - textTitle: Seurat and the Impressionists
    text: >-
      ...
      In 1879, Seurat attended the Fourth Impressionist Exhibition where he had the opportunity to see works by artists such as [Claude Monet](https://ia-prototype.larsbehrenberg.com/claude-monet-biography.html) and [Camille Pissarro](https://ia-prototype.larsbehrenberg.com/camille-pissarro-biography.html). This was an important moment for him as he was confronted with a new form of artistic expression that shunned the academic rules enforced on artists at the time, including himself.
  ...
  - textTitle: Seurat and Neo-Impressionism
    text: >-
      ...
      This particular painting would be Seurat’s last. Indeed, it was unfinished at his death. Almost predicting his fate, Seurat chose to exhibit the work only partially completed in the Salon des Independants. His friend and fellow [Post-Impressionist Paul Signac](https://ia-prototype.larsbehrenberg.com/paul-signac-biography.html) purchased the painting soon afterwards.
...
This method of applying dots of paint to create cumulative colour effects was Seurat’s defining contribution to 19th century French art. At a time of great artistic innovation, Seurat forged [his own, novel path](https://ia-prototype.larsbehrenberg.com/georges-seurat-biography.html#1).

Through his original approach to painting using colour theory, Seurat moved away from the foundations of the [Impressionist movement](https://ia-prototype.larsbehrenberg.com/georges-seurat-biography.html#2). Rather than working to capture a fleeting moment in time, he chose to produce carefully considered and stately works, albeit in a similar colour palette to the Impressionists.

In doing so, Seurat inspired a [new generation of artists](https://ia-prototype.larsbehrenberg.com/georges-seurat-biography.html#3) to experiment with colour and particularly the technique of ‘mélange optique’ or optical mixing, to give their paintings greater vibrance and intensity. Before he reached the age of 30, Seurat had already established himself as the [new leader of the French avant-garde](https://ia-prototype.larsbehrenberg.com/georges-seurat-biography.html#4).
