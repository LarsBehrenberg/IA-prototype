...
class Game extends React.Component {
  ...
  getNewQuestion = () => {
    ...
    document.getElementById(
      'question'
    ).innerText = this.currentQuestion.question
    Array.from(document.getElementsByClassName('choice-text')).forEach(
      choice => {
    ...
    Array.from(document.getElementsByClassName('choice-text')).forEach(
      choice => {
        choice.addEventListener('click', e => {
          ...
          const classToApply =
            selectedAnswer === this.currentQuestion.answer
              ? 'correct'
              : 'incorrect'
    ...
    return (
      <div className="container2">
        <div id="game" className="justify-center flex-column">
          ...
          <h2 id="question">
            In what year did Manet, after 20 years of trying, finally win a
            medal at the Salon des Beaux Arts?
          </h2>
