...
const Suggestion = ({ previousNeighbor, nextNeighbor }) => {
    ...
    console.log(previousNeighbor.frontmatter)
    return (
                      ...
                      <div className="ttde-gallery-inner">
                        <div className="ttde-gallery-bottom">
                           <div className="ttde-gallery-col ttde-gallery-col-1">
                            <div className="ttde-gallery-col-inner"> <Link className="ttde-gallery-url" to={previousNeighbor.frontmatter.path} data-gallery="" title={previousNeighbor.frontmatter.title}><span className="ttde-gallery-open-btn"><span>{previousNeighbor.frontmatter.title}</span></span><img alt={previousNeighbor.frontmatter.title} className="loaded" src={"assets/" + previousNeighbor.frontmatter.cover.relativePath} data-was-processed="true" /></Link>
                            </div>
                          </div>
                          ...
                          <div className="ttde-gallery-col-inner"> <Link className="ttde-gallery-url" to={nextNeighbor.frontmatter.path} data-gallery="" title={nextNeighbor.frontmatter.title}><span className="ttde-gallery-open-btn"><span>{nextNeighbor.frontmatter.title}</span></span><img alt={nextNeighbor.frontmatter.title} className="loaded" src={"assets/" + nextNeighbor.frontmatter.cover.relativePath} data-was-processed="true" /></Link>
                            </div>
                          </div>
                        </div>
                      </div>
